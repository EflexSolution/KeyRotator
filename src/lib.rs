...
#[derive(Debug)]
pub struct KeyRotatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl KeyRotatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting KeyRotator processing");
    
    let mut processor = KeyRotatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = KeyRotatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = KeyRotatorProcessor::new(false);
